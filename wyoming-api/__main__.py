...
async def main() -> None:
    ...
    parser.add_argument("--api", required=True, help="URL of whisper.cpp to use")
    parser.add_argument("--uri", required=True, help="unix:// or tcp://")
    parser.add_argument("--model", default=None, help="Model name")
    parser.add_argument("--initial-prompt", default="", help="Initial prompt for transcription")
    ...
    await server.run(
        partial(WhisperAPIEventHandler, wyoming_info, args)
    )
